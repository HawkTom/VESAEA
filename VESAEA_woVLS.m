function [recordBehaviour, flagRCD, sample] = VESAEA_woVLS(benchmark, lu, sample, AdaptiveFE)
...
%         new_sample = PSO(fhd, n, lu);
    ...
    flagRCD = [flagRCD;flag];
    recordBehaviour = [recordBehaviour; min(sample.y) flag];
    fprintf('VESAEA_woVLS: sample index: %d Min: %f flag: %d \n', fe, min(sample.y), flag);
