function C = gpml_sq_dist(a, b, Q)
% gpml_sq_dist - a function to compute a matrix of all pairwise squared distances
...
% contained in the file gpml_sq_dist.c, and should be compiled using matlabs mex
...
%
% Usage: C = gpml_sq_dist(a, b)
%    or: C = gpml_sq_dist(a)  or equiv.: C = gpml_sq_dist(a, [])
%    or: c = gpml_sq_dist(a, b, Q)
